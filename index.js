...
bitcore.versionGuard = function (version) {
  if (version !== undefined) {
    var message =
      'More than one instance of lkscore-lib found. ' +
      'Please make sure that you are not mixing instances of classes of the different versions of lkscore.';
    console.warn(message);
  }
};
bitcore.versionGuard(global._lkscore);
global._lkscore = bitcore.version;
