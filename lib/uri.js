 ...
 * ```javascript
 *
 * var uri = new URI('lkscoin:XsV4GHVKGTjQFvwB7c6mYsGV3Mxf7iser6?amount=1.2');
 ...
 * ```javascript
 *
 * var valid = URI.isValid('lkscoin:XsV4GHVKGTjQFvwB7c6mYsGV3Mxf7iser6');
 * // true
 * ```
 *
...
URI.parse = function (uri) {
  ...
  if (info.protocol !== 'lkscoin:') {
    throw new TypeError('Invalid lkscoin URI');
  }
...
URI.prototype._fromObject = function (obj) {
  ...
  if (!Address.isValid(obj.address)) {
    throw new TypeError('Invalid lkscoin address');
  }
